...
//            OnInteractableObjectUsed(SetInteractableObjectEvent(currentUsingGameObject));
            ...
            // MSwanson - Moved this beyond the usingObject set so that IsUsed is true when the event is raised
            OnInteractableObjectUsed(SetInteractableObjectEvent(currentUsingGameObject));
        }
...
//            OnInteractableObjectUnused(SetInteractableObjectEvent(previousUsingGameObject));
            ...
            // MSwanson - Moved this beyond the reset so that IsUsed is false when the event is raised
            OnInteractableObjectUnused(SetInteractableObjectEvent(previousUsingGameObject));
        }
