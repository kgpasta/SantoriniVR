...
namespace VRTK
{
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public enum ButtonAlias
        {
            ...
            PinkyFingerSense,
            /// <summary>
            /// The button three is touched.
            /// </summary>
            ButtonThreeTouch,
            /// <summary>
            /// The button three is pressed.
            /// </summary>
            ButtonThreePress,
            /// <summary>
            /// The button four is touched.
            /// </summary>
            ButtonFourTouch,
            /// <summary>
            /// The button four is pressed.
            /// </summary>
            ButtonFourPress,
            /// <summary>
            /// The button five is touched.
            /// </summary>
            ButtonFiveTouch,
            /// <summary>
            /// The button five is pressed.
            /// </summary>
            ButtonFivePress,
            /// <summary>
            /// The button six is touched.
            /// </summary>
            ButtonSixTouch,
            /// <summary>
            /// The button six is pressed.
            /// </summary>
            ButtonSixPress
        }
        ...
        #region button three bool states
        /// <summary>
        /// This will be true if button three is held down.
        /// </summary>
        [HideInInspector]
        public bool buttonThreePressed = false;
        /// <summary>
        /// This will be true if button three is being touched.
        /// </summary>
        [HideInInspector]
        public bool buttonThreeTouched = false;
        #endregion button three bool states

        #region button four bool states
        /// <summary>
        /// This will be true if button four is held down.
        /// </summary>
        [HideInInspector]
        public bool buttonFourPressed = false;
        /// <summary>
        /// This will be true if button four is being touched.
        /// </summary>
        [HideInInspector]
        public bool buttonFourTouched = false;
        #endregion button four bool states

        #region button five bool states
        /// <summary>
        /// This will be true if button five is held down.
        /// </summary>
        [HideInInspector]
        public bool buttonFivePressed = false;
        /// <summary>
        /// This will be true if button five is being touched.
        /// </summary>
        [HideInInspector]
        public bool buttonFiveTouched = false;
        #endregion button five bool states

        #region button six bool states
        /// <summary>
        /// This will be true if button six is held down.
        /// </summary>
        [HideInInspector]
        public bool buttonSixPressed = false;
        /// <summary>
        /// This will be true if button six is being touched.
        /// </summary>
        [HideInInspector]
        public bool buttonSixTouched = false;
        #endregion button six bool states
        ...
        #endregion controller button two events

        #region controller button three events
        /// <summary>
        /// Emitted when button one is touched.
        /// </summary>
        ...
        #endregion controller button three events

        #region controller button four events
        /// <summary>
        /// Emitted when button one is touched.
        /// </summary>
        ...
        #endregion controller button four events

        #region controller button five events
        /// <summary>
        /// Emitted when button one is touched.
        /// </summary>
        public event ControllerInteractionEventHandler ButtonFiveTouchStart;
        /// <summary>
        /// Emitted when button one is no longer being touched.
        /// </summary>
        public event ControllerInteractionEventHandler ButtonFiveTouchEnd;
        /// <summary>
        /// Emitted when button one is pressed.
        /// </summary>
        ...
        #endregion controller button five events

        #region controller button six events
        /// <summary>
        /// Emitted when button one is touched.
        /// </summary>
        public event ControllerInteractionEventHandler ButtonSixTouchStart;
        /// <summary>
        /// Emitted when button one is no longer being touched.
        /// </summary>
        public event ControllerInteractionEventHandler ButtonSixTouchEnd;
        /// <summary>
        /// Emitted when button one is pressed.
        /// </summary>
        ...
        #endregion controller button six events
        ...
        #region event button three methods
        public virtual void OnButtonThreeTouchStart(ControllerInteractionEventArgs e)
        {
            if (ButtonThreeTouchStart != null)
            {
                ButtonThreeTouchStart(this, e);
            }
        }

        public virtual void OnButtonThreeTouchEnd(ControllerInteractionEventArgs e)
        {
            if (ButtonThreeTouchEnd != null)
            {
                ButtonThreeTouchEnd(this, e);
            }
        }

        public virtual void OnButtonThreePressed(ControllerInteractionEventArgs e)
        {
            if (ButtonThreePressed != null)
            {
                ButtonThreePressed(this, e);
            }
        }

        public virtual void OnButtonThreeReleased(ControllerInteractionEventArgs e)
        {
            if (ButtonThreeReleased != null)
            {
                ButtonThreeReleased(this, e);
            }
        }
        #endregion event button three methods

        #region event button four methods
        public virtual void OnButtonFourTouchStart(ControllerInteractionEventArgs e)
        {
            if (ButtonFourTouchStart != null)
            {
                ButtonFourTouchStart(this, e);
            }
        }

        public virtual void OnButtonFourTouchEnd(ControllerInteractionEventArgs e)
        {
            if (ButtonFourTouchEnd != null)
            {
                ButtonFourTouchEnd(this, e);
            }
        }

        public virtual void OnButtonFourPressed(ControllerInteractionEventArgs e)
        {
            if (ButtonFourPressed != null)
            {
                ButtonFourPressed(this, e);
            }
        }

        public virtual void OnButtonFourReleased(ControllerInteractionEventArgs e)
        {
            if (ButtonFourReleased != null)
            {
                ButtonFourReleased(this, e);
            }
        }
        #endregion event button four methods

        #region event button five methods
        public virtual void OnButtonFiveTouchStart(ControllerInteractionEventArgs e)
        {
            if (ButtonFiveTouchStart != null)
            {
                ButtonFiveTouchStart(this, e);
            }
        }

        public virtual void OnButtonFiveTouchEnd(ControllerInteractionEventArgs e)
        {
            if (ButtonFiveTouchEnd != null)
            {
                ButtonFiveTouchEnd(this, e);
            }
        }

        public virtual void OnButtonFivePressed(ControllerInteractionEventArgs e)
        {
            if (ButtonFivePressed != null)
            {
                ButtonFivePressed(this, e);
            }
        }

        public virtual void OnButtonFiveReleased(ControllerInteractionEventArgs e)
        {
            if (ButtonFiveReleased != null)
            {
                ButtonFiveReleased(this, e);
            }
        }
        #endregion event button five methods

        #region event button six methods
        public virtual void OnButtonSixTouchStart(ControllerInteractionEventArgs e)
        {
            if (ButtonSixTouchStart != null)
            {
                ButtonSixTouchStart(this, e);
            }
        }

        public virtual void OnButtonSixTouchEnd(ControllerInteractionEventArgs e)
        {
            if (ButtonSixTouchEnd != null)
            {
                ButtonSixTouchEnd(this, e);
            }
        }

        public virtual void OnButtonSixPressed(ControllerInteractionEventArgs e)
        {
            if (ButtonSixPressed != null)
            {
                ButtonSixPressed(this, e);
            }
        }

        public virtual void OnButtonSixReleased(ControllerInteractionEventArgs e)
        {
            if (ButtonSixReleased != null)
            {
                ButtonSixReleased(this, e);
            }
        }
        #endregion event button six methods
        ...
        {
            return (triggerPressed || gripPressed || touchpadPressed || buttonOnePressed || buttonTwoPressed || buttonThreePressed || buttonFourPressed || buttonFivePressed || buttonSixPressed || startMenuPressed);
        }
        ...
        public virtual bool IsButtonPressed(ButtonAlias button)
        {
            switch (button)
            {
                ...
                case ButtonAlias.ButtonThreePress:
                    return buttonThreePressed;
                case ButtonAlias.ButtonThreeTouch:
                    return buttonThreeTouched;
                case ButtonAlias.ButtonFourPress:
                    return buttonFourPressed;
                case ButtonAlias.ButtonFourTouch:
                    return buttonFourTouched;
                case ButtonAlias.ButtonFivePress:
                    return buttonFivePressed;
                case ButtonAlias.ButtonFiveTouch:
                    return buttonFiveTouched;
                case ButtonAlias.ButtonSixPress:
                    return buttonSixPressed;
                case ButtonAlias.ButtonSixTouch:
                    return buttonSixTouched;
        ...
        protected virtual void Update()
        {
            ...
            CheckButtonThreeEvents(controllerReference);
            CheckButtonFourEvents(controllerReference);
            CheckButtonFiveEvents(controllerReference);
            CheckButtonSixEvents(controllerReference);
        ...
        protected virtual void CheckButtonThreeEvents(VRTK_ControllerReference controllerReference)
        {
            //ButtonThree Touched
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonThree, SDK_BaseController.ButtonPressTypes.TouchDown, controllerReference))
            {
                OnButtonThreeTouchStart(SetControllerEvent(ref buttonThreeTouched, true, 1f));
            }

            //ButtonThree Pressed
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonThree, SDK_BaseController.ButtonPressTypes.PressDown, controllerReference))
            {
                OnButtonThreePressed(SetControllerEvent(ref buttonThreePressed, true, 1f));
            }
            else if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonThree, SDK_BaseController.ButtonPressTypes.PressUp, controllerReference))
            {
                OnButtonThreeReleased(SetControllerEvent(ref buttonThreePressed, false, 0f));
            }

            //ButtonThree Touched End
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonThree, SDK_BaseController.ButtonPressTypes.TouchUp, controllerReference))
            {
                OnButtonThreeTouchEnd(SetControllerEvent(ref buttonThreeTouched, false, 0f));
            }
        }

        protected virtual void CheckButtonFourEvents(VRTK_ControllerReference controllerReference)
        {
            //ButtonFour Touched
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFour, SDK_BaseController.ButtonPressTypes.TouchDown, controllerReference))
            {
                OnButtonFourTouchStart(SetControllerEvent(ref buttonFourTouched, true, 1f));
            }

            //ButtonFour Pressed
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFour, SDK_BaseController.ButtonPressTypes.PressDown, controllerReference))
            {
                OnButtonFourPressed(SetControllerEvent(ref buttonFourPressed, true, 1f));
            }
            else if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFour, SDK_BaseController.ButtonPressTypes.PressUp, controllerReference))
            {
                OnButtonFourReleased(SetControllerEvent(ref buttonFourPressed, false, 0f));
            }

            //ButtonFour Touched End
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFour, SDK_BaseController.ButtonPressTypes.TouchUp, controllerReference))
            {
                OnButtonFourTouchEnd(SetControllerEvent(ref buttonFourTouched, false, 0f));
            }
        }

        protected virtual void CheckButtonFiveEvents(VRTK_ControllerReference controllerReference)
        {
            //ButtonFive Touched
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFive, SDK_BaseController.ButtonPressTypes.TouchDown, controllerReference))
            {
                OnButtonFiveTouchStart(SetControllerEvent(ref buttonFiveTouched, true, 1f));
            }

            //ButtonFive Pressed
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFive, SDK_BaseController.ButtonPressTypes.PressDown, controllerReference))
            {
                OnButtonFivePressed(SetControllerEvent(ref buttonFivePressed, true, 1f));
            }
            else if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFive, SDK_BaseController.ButtonPressTypes.PressUp, controllerReference))
            {
                OnButtonFiveReleased(SetControllerEvent(ref buttonFivePressed, false, 0f));
            }

            //ButtonFive Touched End
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonFive, SDK_BaseController.ButtonPressTypes.TouchUp, controllerReference))
            {
                OnButtonFiveTouchEnd(SetControllerEvent(ref buttonFiveTouched, false, 0f));
            }
        }

        protected virtual void CheckButtonSixEvents(VRTK_ControllerReference controllerReference)
        {
            //ButtonSix Touched
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonSix, SDK_BaseController.ButtonPressTypes.TouchDown, controllerReference))
            {
                OnButtonSixTouchStart(SetControllerEvent(ref buttonSixTouched, true, 1f));
            }

            //ButtonSix Pressed
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonSix, SDK_BaseController.ButtonPressTypes.PressDown, controllerReference))
            {
                OnButtonSixPressed(SetControllerEvent(ref buttonSixPressed, true, 1f));
            }
            else if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonSix, SDK_BaseController.ButtonPressTypes.PressUp, controllerReference))
            {
                OnButtonSixReleased(SetControllerEvent(ref buttonSixPressed, false, 0f));
            }

            //ButtonSix Touched End
            if (VRTK_SDK_Bridge.GetControllerButtonState(SDK_BaseController.ButtonTypes.ButtonSix, SDK_BaseController.ButtonPressTypes.TouchUp, controllerReference))
            {
                OnButtonSixTouchEnd(SetControllerEvent(ref buttonSixTouched, false, 0f));
            }
        }
            ...
            switch (givenButton)
            {
                ...
                case ButtonAlias.ButtonThreePress:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonThreePressed += callbackMethod;
                        }
                        else
                        {
                            ButtonThreeReleased += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonThreeTouch:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonThreeTouchStart += callbackMethod;
                        }
                        else
                        {
                            ButtonThreeTouchEnd += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonFourTouch:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonFourTouchStart += callbackMethod;
                        }
                        else
                        {
                            ButtonFourTouchEnd += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonFivePress:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonFivePressed += callbackMethod;
                        }
                        else
                        {
                            ButtonFiveReleased += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonFiveTouch:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonFiveTouchStart += callbackMethod;
                        }
                        else
                        {
                            ButtonFiveTouchEnd += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonSixPress:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonSixPressed += callbackMethod;
                        }
                        else
                        {
                            ButtonSixReleased += callbackMethod;
                        }
                    }
                    else
                    {
                ...
                case ButtonAlias.ButtonSixTouch:
                    if (subscribe)
                    {
                        if (startEvent)
                        {
                            ButtonSixTouchStart += callbackMethod;
                        }
                        else
                        {
                            ButtonSixTouchEnd += callbackMethod;
                        }
                    }
                    else
                    {
