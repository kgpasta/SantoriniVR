namespace VRTK.UnityEventHelper
{
    ...
    public sealed class VRTK_ControllerEvents_UnityEvents : VRTK_UnityEvents<VRTK_ControllerEvents>
    {
        ...
        public ControllerInteractionEvent OnButtonThreePressed = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonThreeReleased = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonThreeTouchStart = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonThreeTouchEnd = new ControllerInteractionEvent();

        public ControllerInteractionEvent OnButtonFourPressed = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFourReleased = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFourTouchStart = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFourTouchEnd = new ControllerInteractionEvent();

        public ControllerInteractionEvent OnButtonFivePressed = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFiveReleased = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFiveTouchStart = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonFiveTouchEnd = new ControllerInteractionEvent();

        public ControllerInteractionEvent OnButtonSixPressed = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonSixReleased = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonSixTouchStart = new ControllerInteractionEvent();
        public ControllerInteractionEvent OnButtonSixTouchEnd = new ControllerInteractionEvent();
        ...
        protected override void AddListeners(VRTK_ControllerEvents component)
        {
            ...
            component.ButtonThreePressed += ButtonThreePressed;
            component.ButtonThreeReleased += ButtonThreeReleased;
            component.ButtonThreeTouchStart += ButtonThreeTouchStart;
            component.ButtonThreeTouchEnd += ButtonThreeTouchEnd;

            component.ButtonFourPressed += ButtonFourPressed;
            component.ButtonFourReleased += ButtonFourReleased;
            component.ButtonFourTouchStart += ButtonFourTouchStart;
            component.ButtonFourTouchEnd += ButtonFourTouchEnd;

            component.ButtonFivePressed += ButtonFivePressed;
            component.ButtonFiveReleased += ButtonFiveReleased;
            component.ButtonFiveTouchStart += ButtonFiveTouchStart;
            component.ButtonFiveTouchEnd += ButtonFiveTouchEnd;

            component.ButtonSixPressed += ButtonSixPressed;
            component.ButtonSixReleased += ButtonSixReleased;
            component.ButtonSixTouchStart += ButtonSixTouchStart;
            component.ButtonSixTouchEnd += ButtonSixTouchEnd;
        ...
        {
            OnButtonThreePressed.Invoke(o, e);
        }

        private void ButtonThreeReleased(object o, ControllerInteractionEventArgs e)
        {
            OnButtonThreeReleased.Invoke(o, e);
        }

        private void ButtonThreeTouchStart(object o, ControllerInteractionEventArgs e)
        {
            OnButtonThreeTouchStart.Invoke(o, e);
        }

        private void ButtonThreeTouchEnd(object o, ControllerInteractionEventArgs e)
        {
            OnButtonThreeTouchEnd.Invoke(o, e);
        }

        private void ButtonFourPressed(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFourPressed.Invoke(o, e);
        }

        private void ButtonFourReleased(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFourReleased.Invoke(o, e);
        }

        private void ButtonFourTouchStart(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFourTouchStart.Invoke(o, e);
        }

        private void ButtonFourTouchEnd(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFourTouchEnd.Invoke(o, e);
        }

        private void ButtonFivePressed(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFivePressed.Invoke(o, e);
        }

        private void ButtonFiveReleased(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFiveReleased.Invoke(o, e);
        }

        private void ButtonFiveTouchStart(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFiveTouchStart.Invoke(o, e);
        }

        private void ButtonFiveTouchEnd(object o, ControllerInteractionEventArgs e)
        {
            OnButtonFiveTouchEnd.Invoke(o, e);
        }

        private void ButtonSixPressed(object o, ControllerInteractionEventArgs e)
        {
            OnButtonSixPressed.Invoke(o, e);
        }

        private void ButtonSixReleased(object o, ControllerInteractionEventArgs e)
        {
            OnButtonSixReleased.Invoke(o, e);
        }

        private void ButtonSixTouchStart(object o, ControllerInteractionEventArgs e)
        {
            OnButtonSixTouchStart.Invoke(o, e);
        }

        private void ButtonSixTouchEnd(object o, ControllerInteractionEventArgs e)
        {
            OnButtonSixTouchEnd.Invoke(o, e);
        }
