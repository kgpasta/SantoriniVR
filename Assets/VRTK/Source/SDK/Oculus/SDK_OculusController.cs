        ...
        public override bool GetControllerButtonState(ButtonTypes buttonType, ButtonPressTypes pressType, VRTK_ControllerReference controllerReference)
        {
            ...
            switch (buttonType)
            {
                ...
                case ButtonTypes.ButtonTwo:
                    ...
                    break;
                case ButtonTypes.ButtonThree:
                    switch (pressType)
                    {
                        case ButtonPressTypes.Press:
                        case ButtonPressTypes.PressDown:
                        case ButtonPressTypes.PressUp:
                            return IsButtonPressed(index, pressType, OVRInput.Button.DpadUp);
                    }
                    break;
                case ButtonTypes.ButtonFour:
                    switch (pressType)
                    {
                        case ButtonPressTypes.Press:
                        case ButtonPressTypes.PressDown:
                        case ButtonPressTypes.PressUp:
                            return IsButtonPressed(index, pressType, OVRInput.Button.DpadDown);
                    }
                    break;
                case ButtonTypes.ButtonFive:
                    switch (pressType)
                    {
                        case ButtonPressTypes.Press:
                        case ButtonPressTypes.PressDown:
                        case ButtonPressTypes.PressUp:
                            return IsButtonPressed(index, pressType, OVRInput.Button.DpadRight);
                    }
                    break;
                case ButtonTypes.ButtonSix:
                    switch (pressType)
                    {
                        case ButtonPressTypes.Press:
                        case ButtonPressTypes.PressDown:
                        case ButtonPressTypes.PressUp:
                            return IsButtonPressed(index, pressType, OVRInput.Button.DpadLeft);
                    }
                    break;
