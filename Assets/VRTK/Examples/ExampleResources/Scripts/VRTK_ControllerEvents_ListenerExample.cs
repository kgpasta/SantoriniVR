namespace VRTK.Examples
{
    ...
    public class VRTK_ControllerEvents_ListenerExample : MonoBehaviour
    {
        ...
        public bool buttonThreeButtonEvents = true;
        public bool buttonFourButtonEvents = true;
        public bool buttonFiveButtonEvents = true;
        public bool buttonSixButtonEvents = true;
        ...
        private void LateUpdate()
        {
            switch (quickSelect)
            {
                case EventQuickSelect.None:
                    ...
                    buttonThreeButtonEvents = false;
                    buttonFourButtonEvents = false;
                    buttonFiveButtonEvents = false;
                    buttonSixButtonEvents = false;
                ...
                case EventQuickSelect.All:
                    ...
                    buttonThreeButtonEvents = true;
                    buttonFourButtonEvents = true;
                    buttonFiveButtonEvents = true;
                    buttonSixButtonEvents = true;
        ...
        {
            if (buttonThreeButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON THREE", "pressed down", e);
            }
        }
        ...
        private void DoButtonThreeReleased(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonThreeButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON THREE", "released", e);
            }
        }
        ...
        private void DoButtonThreeTouchStart(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonThreeButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON THREE", "touched", e);
            }
        }
        ...
        private void DoButtonThreeTouchEnd(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonThreeButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON THREE", "untouched", e);
            }
        }

        private void DoButtonFourPressed(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFourButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FOUR", "pressed down", e);
            }
        }
        ...
        private void DoButtonFourReleased(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFourButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FOUR", "released", e);
            }
        }
        ...
        private void DoButtonFourTouchStart(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFourButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FOUR", "touched", e);
            }
        }
        ...
        private void DoButtonFourTouchEnd(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFourButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FOUR", "untouched", e);
            }
        }

        private void DoButtonFivePressed(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFiveButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FIVE", "pressed down", e);
            }
        }
        ...
        private void DoButtonFiveReleased(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFiveButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FIVE", "released", e);
            }
        }

        private void DoButtonFiveTouchStart(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFiveButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FIVE", "touched", e);
            }
        }

        private void DoButtonFiveTouchEnd(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonFiveButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON FIVE", "untouched", e);
            }
        }

        private void DoButtonSixPressed(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonSixButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON SIX", "pressed down", e);
            }
        }
        ...
        private void DoButtonSixReleased(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonSixButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON SIX", "released", e);
            }
        }

        private void DoButtonSixTouchStart(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonSixButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON SIX", "touched", e);
            }
        }

        private void DoButtonSixTouchEnd(object sender, ControllerInteractionEventArgs e)
        {
            if (buttonSixButtonEvents)
            {
                DebugLogger(VRTK_ControllerReference.GetRealIndex(e.controllerReference), "BUTTON SIX", "untouched", e);
            }
        }
